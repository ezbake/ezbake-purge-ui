...
wh.app.controller('ManualInterventionController',
    [ '$scope', 'PurgeService','$location',
    /**
     * @description
     * Routes to the purges requiring manual intervention page to see any
     * purges that require manual intervention. If no purges require
     * manual intervention the page will inform the user of such
     */
        /* $scope.searchForPurgesRequiringManualIntervention = function() {
         $http.get(resourceUrl + "/manual-intervention");
         };*/
        function($scope, PurgeService, $location) {
            PurgeService.getPurgesManualIntervention()
